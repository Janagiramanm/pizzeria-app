        ...
        <form  class="w-full max-w-6xl">
               <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                  ...
                  <x-jet-button wire:click.prevent="update()" class="bg-orange-500 hover:bg-orange-700">
                     Update
                  </x-jet-button>
                  <x-jet-danger-button class="ml-2" wire:click.prevent="cancel()" wire:loading.attr="disabled">
                            {{ __('Cancel') }}
                 </x-jet-danger-button>
                </div>
</form>
